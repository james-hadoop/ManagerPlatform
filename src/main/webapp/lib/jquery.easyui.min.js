...
},beforePageText:"页",afterPageText:"总共 {pages}页",displayMsg:"展示 {from} 到 {to}项 ，共 {total} 项",nav:{first:{iconCls:"pagination-first",handler:function(){
...
$(this)._outerHeight(opts.itemHeight+5);
$(this).find(".menu-text").css({height:(opts.itemHeight+5)+"px",lineHeight:(opts.itemHeight+5)+"px"});
});
...
menu.children("div.menu-line")._outerHeight(_403+20);
};
...
_a4d(this,q);
}},currentText:"Today",closeText:"取消",okText:"确定",buttons:[{text:function(_a62){
